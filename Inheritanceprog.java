...
class Inheritanceprog //main class
{
	//main method
	public static void main(String[] args)
	{
		//object creation
		Manager m=new Manager(767697,"salman khan","afghanistan UAE",9776767,859739.00);
		m.calculateSalary();
		m.calculateTransportAllowance();

		Trainee t=new Trainee(98455,"Amulya","karnataka India",9739771,349739.00);
		t.calculateSalary();
